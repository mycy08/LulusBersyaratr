                ...
                if(clus==2){
                    ...
                    for (var i = 0; i < rekomendasi.length; i++) {
                        ...
                        for (var j = 0; j < rekomendasi.length; j++) {
                            ...
                            hSementaraUp = ((prob1[i] - rataC1)*(prob1[j] - rataC1)) +
                                           ((prob2[i] - rataC2)*(prob2[j] - rataC2))
                            
                            hSementaraDown = Math.sqrt(((prob1[i] - rataC1)*(prob1[i] - rataC1)) + (prob2[i] - rataC2)*(prob2[i] - rataC2)) *
                                            Math.sqrt(((prob1[j] - rataC1)*(prob1[j] - rataC1)) + (prob2[j] - rataC2)*(prob2[j] - rataC2))

                            groupRating.push(hSementaraUp/ hSementaraDown)
                                            ...
                                            collection.find({}, {
                                                ...
                                                for(var i=0;i<anime.length;i++){                                                   
                                                        for(var k=0;k<rating.length;k++){
                                                            if(rating[k].id_anime==anime[i]._id){
                                                                ratPerUser.push({
                                                                    id_user:rating[k].id_user,
                                                                    id_anime:rating[k].id_anime,
                                                                    nama_anime:anime[i].nama_anime,
                                                                    score:rating[k].score
                                                                })
                                                            }
                                                        
                                                    }
                                                    ratUser.push(ratPerUser)
                                                    ratPerUser=[]        
                                                }
                                               // console.log(ratUser[0][0].score)
                                               // return res.json(ratUser)
                                              

                                               
                                                var itemRating = []
                                                
                                                //console.log(ratUser.length)
                                                for(var i =0;i<ratUser.length;i++)
                                                {
                                                    
                                                    
                                                    for(var j = 0;j<ratUser.length;j++)
                                                    {       
                                                            var hsUp = 0
                                                            var hsDown = 0
                                                            var total_1 = 0
                                                            ...
                                                            for(var k = 0; k< ratUser[i].length;k++)
                                                            {
                                                               for(var l = 0; l < ratUser[j].length;l++)
                                                               {
                                                                   if(ratUser[i][k].id_user == ratUser[j][l].id_user)
                                                                    {
                                                                       maxuser++
                                                                       ScoreUserke1.push(ratUser[i][k].score)
                                                                       ScoreUserke2.push(ratUser[j][l].score)
                                                                    }
                                                                }
                                                            }
                                                                    
                                                            for(var l = 0 ; l < maxuser; l++)
                                                            {
                                                                hsUp += ((ScoreUserke1[l] - scoreSem[i]) * (ScoreUserke2[l] - scoreSem[j]))
                                                                total_1 += ((ScoreUserke1[l] - scoreSem[i]) * (ScoreUserke1[l] - scoreSem[i]))
                                                                total_2 += ((ScoreUserke2[l] - scoreSem[j]) * (ScoreUserke2[l] - scoreSem[j]))
                                                                //console.log(scoreSem[i])
                                                                
                                                            }
                                                            
                                                            hsDown = Math.sqrt(total_1) * Math.sqrt(total_2)
                                                ...
                                                for (var i = 0; i < groupRating.length; i++) {
                                                    hasil = (itemRating[i] * (1-c)) + (groupRating[i] * c)
                                                    simi.push(hasil)
                                                }
                    ...
                    iterasi++
                                ...
                                for (var i = 0; i < rekomendasi.length; i++) {
                                    ...
                                    for (var j = 0; j < rekomendasi.length; j++) {
                                        ...
                                        hSementaraUp = ((prob1[i] - rataC1)*(prob1[j] - rataC1)) +
                                                       ((prob2[i] - rataC2)*(prob2[j] - rataC2)) +
                                                       ((prob3[i] - rataC3)*(prob3[j] - rataC3))
                                        
                                        hSementaraDown = Math.sqrt(((prob1[i] - rataC1)*(prob1[i] - rataC1)) + (prob2[i] - rataC2)*(prob2[i] - rataC2) + (prob3[i] - rataC3)*(prob3[i] - rataC3)) *
                                                        Math.sqrt(((prob1[j] - rataC1)*(prob1[j] - rataC1)) + (prob2[j] - rataC2)*(prob2[j] - rataC2) +(prob3[j] - rataC3) *(prob3[j] - rataC3))
                                ...
                                for (var i = 0; i < rekomendasi.length; i++) {
                                    ...
                                    for (var j = 0; j < rekomendasi.length; j++) {
                                        ...
                                        hSementaraUp = ((prob1[i] - rataC1)*(prob1[j] - rataC1)) +
                                                       ((prob2[i] - rataC2)*(prob2[j] - rataC2)) +
                                                       ((prob3[i] - rataC3)*(prob3[j] - rataC3)) +
                                                       ((prob4[i] - rataC4)*(prob4[j] - rataC4))
                                        
                                        hSementaraDown = Math.sqrt(((prob1[i] - rataC1)*(prob1[i] - rataC1)) + (prob2[i] - rataC2)*(prob2[i] - rataC2) + (prob3[i] - rataC3)*(prob3[i] - rataC3)+
                                                                    (prob4[i] - rataC4)*(prob4[i] - rataC4))
                                                                *
                                                        Math.sqrt(((prob1[j] - rataC1)*(prob1[j] - rataC1)) + (prob2[j] - rataC2)*(prob2[j] - rataC2) +(prob3[j] - rataC3) *(prob3[j] - rataC3)+
                                                        (prob4[j] - rataC4)*(prob4[j] - rataC4))
                ...
                for (var i = 0; i < rekomendasi.length; i++) {
                    ...
                    for (var j = 0; j < rekomendasi.length; j++) {
                        ...
                        hSementaraUp = ((prob1[i] - rataC1)*(prob1[j] - rataC1)) +
                                        ...
                                        ((prob3[i] - rataC3)*(prob3[j] - rataC3)) +
                                        ((prob4[i] - rataC4)*(prob4[j] - rataC4))+
                                        ((prob5[i] - rataC5)*(prob5[j] - rataC5))
                        
                        hSementaraDown = Math.sqrt(((prob1[i] - rataC1)*(prob1[i] - rataC1)) + (prob2[i] - rataC2)*(prob2[i] - rataC2) + (prob3[i] - rataC3)*(prob3[i] - rataC3)+
                                                    (prob4[i] - rataC4)*(prob4[i] - rataC4)+ (prob5[i] - rataC5)*(prob5[i] - rataC5))
                                                *
                                        Math.sqrt(((prob1[j] - rataC1)*(prob1[j] - rataC1)) + (prob2[j] - rataC2)*(prob2[j] - rataC2) +(prob3[j] - rataC3) *(prob3[j] - rataC3)+
                                        (prob4[j] - rataC4)*(prob4[j] - rataC4) +(prob5[j] - rataC5)*(prob5[j] - rataC5))
                ...
                for (var i = 0; i < rekomendasi.length; i++) {
                    ...
                    for (var j = 0; j < rekomendasi.length; j++) {
                        ...
                        hSementaraUp = ((prob1[i] - rataC1)*(prob1[j] - rataC1)) +
                                        ...
                                        ((prob4[i] - rataC4)*(prob4[j] - rataC4))+
                                        ((prob5[i] - rataC5)*(prob5[j] - rataC5))+
                                        ((prob6[i] - rataC6)*(prob6[j] - rataC6))
                        hSementaraDown = Math.sqrt(((prob1[i] - rataC1)*(prob1[i] - rataC1)) + (prob2[i] - rataC2)*(prob2[i] - rataC2) + (prob3[i] - rataC3)*(prob3[i] - rataC3)+
                                                    (prob4[i] - rataC4)*(prob4[i] - rataC4)+ (prob5[i] - rataC5)*(prob5[i] - rataC5)+ (prob6[i] - rataC6)*(prob6[i] - rataC6))
                                                *
                                        Math.sqrt(((prob1[j] - rataC1)*(prob1[j] - rataC1)) + (prob2[j] - rataC2)*(prob2[j] - rataC2) +(prob3[j] - rataC3) *(prob3[j] - rataC3)+
                                        (prob4[j] - rataC4)*(prob4[j] - rataC4) +(prob5[j] - rataC5)*(prob5[j] - rataC5)+ (prob6[j] - rataC6)*(prob6[j] - rataC6))
                ...
                for (var i = 0; i < rekomendasi.length; i++) {
                    ...
                    for (var j = 0; j < rekomendasi.length; j++) {
                        ...
                        hSementaraUp = ((prob1[i] - rataC1)*(prob1[j] - rataC1)) +
                                        ...
                                        ((prob5[i] - rataC5)*(prob5[j] - rataC5))+
                                        ((prob6[i] - rataC6)*(prob6[j] - rataC6))+
                                        ((prob7[i] - rataC7)*(prob7[j] - rataC7))

                        hSementaraDown = Math.sqrt(((prob1[i] - rataC1)*(prob1[i] - rataC1)) + (prob2[i] - rataC2)*(prob2[i] - rataC2) + (prob3[i] - rataC3)*(prob3[i] - rataC3)+
                                                    (prob4[i] - rataC4)*(prob4[i] - rataC4)+ (prob5[i] - rataC5)*(prob5[i] - rataC5)+ (prob6[i] - rataC6)*(prob6[i] - rataC6)+
                                                    (prob7[i] - rataC7)*(prob7[i] - rataC7))
                                                *
                                        Math.sqrt(((prob1[j] - rataC1)*(prob1[j] - rataC1)) + (prob2[j] - rataC2)*(prob2[j] - rataC2) +(prob3[j] - rataC3) *(prob3[j] - rataC3)+
                                        (prob4[j] - rataC4)*(prob4[j] - rataC4) +(prob5[j] - rataC5)*(prob5[j] - rataC5)+ (prob6[j] - rataC6)*(prob6[j] - rataC6)+
                                        (prob7[j] - rataC7)*(prob7[j] - rataC7) )
                ...
                for (var i = 0; i < rekomendasi.length; i++) {
                    ...
                    for (var j = 0; j < rekomendasi.length; j++) {
                        ...
                        hSementaraUp = ((prob1[i] - rataC1)*(prob1[j] - rataC1)) +
                                        ...
                                        ((prob6[i] - rataC6)*(prob6[j] - rataC6))+
                                        ((prob7[i] - rataC7)*(prob7[j] - rataC7))+
                                        ((prob8[i] - rataC8)*(prob8[j] - rataC8))
                        hSementaraDown = Math.sqrt(((prob1[i] - rataC1)*(prob1[i] - rataC1)) + (prob2[i] - rataC2)*(prob2[i] - rataC2) + (prob3[i] - rataC3)*(prob3[i] - rataC3)+
                                                    (prob4[i] - rataC4)*(prob4[i] - rataC4)+ (prob5[i] - rataC5)*(prob5[i] - rataC5)+ (prob6[i] - rataC6)*(prob6[i] - rataC6)+
                                                    (prob7[i] - rataC7)*(prob7[i] - rataC7)+(prob8[i] - rataC8)*(prob8[i] - rataC8))
                                                *
                                        Math.sqrt(((prob1[j] - rataC1)*(prob1[j] - rataC1)) + (prob2[j] - rataC2)*(prob2[j] - rataC2) +(prob3[j] - rataC3) *(prob3[j] - rataC3)+
                                        (prob4[j] - rataC4)*(prob4[j] - rataC4) +(prob5[j] - rataC5)*(prob5[j] - rataC5)+ (prob6[j] - rataC6)*(prob6[j] - rataC6)+
                                        (prob7[j] - rataC7)*(prob7[j] - rataC7)+(prob8[j] - rataC8)*(prob8[j] - rataC8) )
                ...
                for (var i = 0; i < rekomendasi.length; i++) {
                    ...
                    for (var j = 0; j < rekomendasi.length; j++) {
                        ...
                        hSementaraUp = ((prob1[i] - rataC1)*(prob1[j] - rataC1)) +
                                        ...
                                        ((prob7[i] - rataC7)*(prob7[j] - rataC7))+
                                        ((prob8[i] - rataC8)*(prob8[j] - rataC8))+
                                        ((prob9[i] - rataC9)*(prob9[j] - rataC9))
                        hSementaraDown = Math.sqrt(((prob1[i] - rataC1)*(prob1[i] - rataC1)) + (prob2[i] - rataC2)*(prob2[i] - rataC2) + (prob3[i] - rataC3)*(prob3[i] - rataC3)+
                                                    (prob4[i] - rataC4)*(prob4[i] - rataC4)+ (prob5[i] - rataC5)*(prob5[i] - rataC5)+ (prob6[i] - rataC6)*(prob6[i] - rataC6)+
                                                    (prob7[i] - rataC7)*(prob7[i] - rataC7)+(prob8[i] - rataC8)*(prob8[i] - rataC8)+ (prob9[i] - rataC9)*(prob9[i] - rataC9))
                                                *
                                        Math.sqrt(((prob1[j] - rataC1)*(prob1[j] - rataC1)) + (prob2[j] - rataC2)*(prob2[j] - rataC2) +(prob3[j] - rataC3) *(prob3[j] - rataC3)+
                                        (prob4[j] - rataC4)*(prob4[j] - rataC4) +(prob5[j] - rataC5)*(prob5[j] - rataC5)+ (prob6[j] - rataC6)*(prob6[j] - rataC6)+
                                        (prob7[j] - rataC7)*(prob7[j] - rataC7)+(prob8[j] - rataC8)*(prob8[j] - rataC8)+(prob9[j] - rataC9)*(prob9[j] - rataC9) )
